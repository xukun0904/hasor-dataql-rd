 ...
 */
package net.hasor.dataql.rd.db;
 ...
 * @version : 2020-06-03
 */
public interface RpcLookupDataSourceListener extends java.util.EventListener {
    /**
     * 当 DataQL 执行过程中用来获取对应的动态数据源。
     * @param lookupName 要查找的数据源
     * @return 返回最终需要的数据源。
     */
    DatasourceOperation lookUp(String lookupName);
}